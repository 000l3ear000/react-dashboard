...
const TaxPaymentModal = props => {
    ...
    console.log("The state", taxState)

    return (
        <React.Fragment>
            <OverlayTrigger overlay={<Tooltip>Make a payment toward taxes</Tooltip>} style={{ float: "right" }}>
            ...
            <Modal size="lg" show={isLarge} onHide={() => setIsLarge(false)}>
                <Modal.Header closeButton>
                    <Modal.Title as="h5">Tax Payment</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
                        <Form.Group as={Row}>
