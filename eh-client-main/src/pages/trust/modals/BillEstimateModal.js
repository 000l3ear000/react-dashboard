...
const BillEstimateModal = props => {
    ...
    return (
        <React.Fragment>
            <OverlayTrigger overlay={<Tooltip>Add bill estimate to this Trust</Tooltip>} style={{ float: "right" }}>
            ...
            <Modal size="lg" show={isLarge} onHide={() => setIsLarge(false)}>
                <Modal.Header closeButton>
                    <Modal.Title as="h5">Bill Estimate</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
                        <Form.Group as={Row}>
...
export default BillEstimateModal;